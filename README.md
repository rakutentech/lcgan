...
The demo videos can be generated by the following command.

    python main.py --phase video_generation --model_name [MODEL_NAME] --batch_size 1 --img_resolution [IMG_RESOLUTION]
